<?php	
    ...
    $html .= '<th>Data de fechamento:</th>';
	$html .= '<th>Status:</th>';
	$html .= '</tr>';
	$html .= '</thead>';
	$html .= '<tbody>';
	
	$result_transacoes = "SELECT * FROM chamados where status = 'Resolvido'";
	...
	// Carrega seu HTML
	$dompdf->load_html('
			<h1 style="text-align: center;">System Help Desk - Relatório de chamados resolvidos</h1>
			'. $html .'
		');
